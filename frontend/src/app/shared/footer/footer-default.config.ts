...
export const DEFAULT_FOOTER_CONFIG: FooterConfig = {
  columns: [
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'Nos partenaires de confiance', url: '/partenaires-confiance' },
  ...
  securitySection: {
    ...
    badges: ['PCI DSS', 'Paiement securise', 'Visa Secure', 'ID Check'],
  },
  paymentSection: {
    title: 'Nous acceptons',
    badges: ['Bancontact', 'Klarna', 'Visa', 'Mastercard', 'PayPal', 'Apple Pay'],
  },
  legal: {
